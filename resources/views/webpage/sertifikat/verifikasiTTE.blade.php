...
<head>
    ...
    @endproduction
    <title>Verifikasi Sertifikat Tanda Tangan Elektronik</title>
</head>
    ...
    <div class="w-full max-w-sm">
        <div class="bg-white rounded-lg shadow-md px-4 py-6 space-y-2">
            ...
            <div class="flex items-center justify-center gap-1 pb-2">
                ...
                <span class="text-green-700 font-normal">Sertifikat Telah Diverifikasi TTE</span>
            </div>
            ...
            <div class="space-y-2">
                ...
                <!-- Nomor Surat -->
                <div>
                    <label class="block text-zinc-800 font-medium text-sm mb-1">Nomor Sertifikat:</label>
                    <p class="text-green-700 font-normal text-sm">{{ $signature->nomor }}</p>
                </div>

                <!-- Tanggal Dibuat -->
                <div>
                    <label class="block text-zinc-800 font-medium text-sm mb-1">Tanggal Diterbitkan:</label>
                    <p class="text-green-700 font-normal text-sm">
                        {{ $signature->created_at ? $signature->created_at->translatedFormat('j F Y') : 'N/A' }}</p>
                </div>

                <!-- Ditandatangani oleh -->
                <div>
                    <label class="block text-zinc-800 font-medium text-sm mb-1">Disahkan oleh:</label>
                ...
                <!-- Jabatan -->
                <div>
                    <label class="block text-zinc-800 font-medium text-sm mb-1">Jabatan Pemegang Wewenang:</label>
                ...
                <div>
                    <label class="block text-zinc-800 font-medium text-sm mb-1">Keperluan Sertifikat:</label>
                ...
                <!-- Unduh Berkas -->
                <div class="pt-2">
                    <a href="{{ asset('storage/' . $signature->file) }}" target="_blank" class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded transition duration-150">
                        Lihat / Unduh Berkas Pendukung
                    </a>
                </div>
                @endif
            </div>
